...
public class Person {
    ...
    public Person(String name) {
        this.name = name;
        // Initialize starting money and loan
        balance = 1000;     // starting money (Rs.)
        loan = 0;           // outstanding loan (Rs.)
        // small randomization
    ...
    public void showStatus() {
        ...
        p.InitialHappiness = happiness;
        p.InitialIntelligence = intelligence;
        p.InitialLooks = looks;
        p.InitialStress = stress;
    ...
    public String modHappiness(int delta) {
        ...
        return (" (Happiness " + delta + ")");
    }

    public String modHealth(int delta) {
        health = clamp(health + delta);
        return (" (Health " + delta + ")");
    }

    public String modIntelligence(int delta) {
        intelligence = clamp(intelligence + delta);
        return (" (Intelligence " + delta + ")");
    }

    public String modLooks(int delta) {
        looks = clamp(looks + delta);
        return (" (Looks " + delta + ")");
    }
