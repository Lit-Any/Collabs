...
/* ---- Games (adapted to long & console prompts) ---- */
    ...
    static int askInt(String prompt) { PrintMethods.p(prompt); return Helpers.readInt(); }
    static String askStr(String prompt) { PrintMethods.p(prompt); return SC.next(); }

    static long gambleDiceGuess(long bet) {
        int guess = askInt("Guess dice roll (1-6): ");
        if (guess < 1 || guess > 6) { PrintMethods.pln("❌ Invalid guess."); return 0; }
    ...
    static long gambleCoinToss(long bet) {
        ...
        if (guess != 1 && guess != 2) { PrintMethods.pln("❌ Invalid choice."); return 0; }
    ...
    static long gambleLuckyNumber(long bet) {
        ...
        if (guess < 1 || guess > 10) { PrintMethods.pln("❌ Invalid number."); return 0; }
    ...
    static long gambleRPS(long bet) {
        ...
        if (user < 1 || user > 3) { PrintMethods.pln("❌ Invalid move."); return 0; }
    ...
    static long gambleHorseRace(long bet) {
        ...
        if (guess < 1 || guess > 5) { PrintMethods.pln("❌ Invalid horse."); return 0; }
    ...
    static long gambleCricket(long bet) {
        ...
        if (guess < 1 || guess > 6) { PrintMethods.pln("❌ Invalid runs."); return 0; }
    ...
    static long gambleFootball(long bet) {
        ...
        if (guess < 1 || guess > 3) { PrintMethods.pln("❌ Invalid direction."); return 0; }
